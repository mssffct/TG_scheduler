...
DOCKER_CONTAINER_MODE = os.getenv('DOCKER_CONTAINER_MODE')  # Code runs in docker
...
MIDDLEWARE = [
    ...
    'users.middleware.TokenAuthMiddleware',  # auth
]

if DAPHNE_DEVELOP_MODE:
...
DATABASES = {
    'default': {
        ...
        'ATOMIC_REQUESTS': True,  # for atomic transactions
    }
}
